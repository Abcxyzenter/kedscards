 	...
 	methods:{
  		...
  		btnright: function(){
			...
			document.getElementById('sld').classList.toggle('rightmove')
 			document.getElementById('sld').style='margin-left:-'+this.transitter+'px; padding-left:'+this.transitter+'px;'

			setTimeout (function(){

				document.getElementById('sld').classList.toggle('rightmove')
 				document.getElementById('sld').style=''
			...
			return this.fromend = this.fromend-1
				...
				setTimeout (function(){
					...
					document.getElementById('sld').style=''
					document.getElementById('sld').classList.toggle('rightmove')}, 250)
  		...
  		btnleft: function(){
			...
			document.getElementById('sld').style='margin-left:-'+this.transitter+'px'
  		...
  		if (1250<screenwin<1600){percentwidth = 0.8}
  		if (1024<screenwin<1250){percentwidth = 0.7}
  		...
  		return this.limSlider = inwrap-1, sliderCartMargin = actualMargin, this.transitter = 205+actualMargin
